...
public class InventoryUpdateVO {
	...
	public InventoryUpdateVO() {
		super();
	}
	public InventoryUpdateVO(int optiStock, int curStock, String prjName, String empName, String itemName,
			String orderDate, String inStockDate, String unit, String status) {
