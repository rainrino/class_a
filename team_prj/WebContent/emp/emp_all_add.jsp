...
System.out.println(eaVO.getDeptName());
System.out.println(eaVO.getEmpName());
...
window.close();
//location.href="emp_all_frm.jsp?empName="+empName+"&position="+position+
		//"&deptName="+deptName+"&email="+email+"&hiredate="+hiredate;
</script>
